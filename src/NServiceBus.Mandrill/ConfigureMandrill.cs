...
namespace NServiceBus
{
    ...
    {
        public static EndpointConfiguration UseMandrill(this EndpointConfiguration settings, string apiKey, bool replyResult = false)
        {
            if (apiKey == null) throw new ArgumentNullException(nameof(apiKey));
            return UseMandrill(settings, new MandrillApi(apiKey), replyResult);
        }

        public static EndpointConfiguration UseMandrill(this EndpointConfiguration settings, MandrillApi api, bool replyResult = false)
        {
        ...
        private static EndpointConfiguration UseMandrill(this EndpointConfiguration settings, IMandrillMessagesApi mandrillApi, bool replyResult = false)
        {
